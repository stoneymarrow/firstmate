...
Herdr workspaces are derived from `FM_HOME`: the primary home uses `firstmate-crew`, and a secondmate home marked by `.fm-secondmate-home` uses `2ndmate-<secondmate-id>`.
