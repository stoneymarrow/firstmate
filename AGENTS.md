...
The scaffold is the single owner of ship and scout parallelism policy, including concurrency, topology, inherited constraints, status-file ownership, sequential fallback, and Herdr-lab guardrails.
