...
tests/fm-brief.test.sh                    # fm-brief.sh bash -n and complete-help regression guards, clean delivery-mode scaffolds, default and task-specific stop conditions, budget validation, and hard Herdr lifecycle declaration/contract tests
